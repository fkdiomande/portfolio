...
export const ChartContainer = ({ id, className, children, config, ...props }: ChartContainerPropsType) => {
...
export const ChartTooltipContent = ({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded bg-white text-primary px-2.5 py-1.5 text-xs shadow-md shadow-black/20",
        className,
      )}
    >
